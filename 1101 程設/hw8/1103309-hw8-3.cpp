       ...
       for(int m=0; m<multiplier.size; m++)
        {
            ...
            {
                buffer.terms[n].expon=multiplier.terms[m].expon+terms[n].expon;
                buffer.terms[n].coef=multiplier.terms[m].coef*terms[n].coef;
            }
   ...
   while(remainder.size!=0&&remainder.terms[0].expon>=divisor.terms[0].expon)
    {
        ...
        monomial.terms[0] = temp.terms[ quotient.size ];
