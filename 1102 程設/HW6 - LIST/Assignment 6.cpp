...
#include <list>
#include "list -1103309 - hw6.h" // include definition of class template list
...
const unsigned int number1 = 500;
const unsigned int number2 = 1000;
const unsigned int number3 = 2000;
...
void testPushFront()
{
   ...
   unsigned int numErrors = number1;
   int value;
   for( unsigned int i = 0; i < number1; i++ )
   {
      value = 1 + rand() % 99;
...
void testResize()
{
   ...
   unsigned int numErrors = number2;
   unsigned int length;
...
void testList()
{
   ...
   unsigned int numErrors = number3;
   int value;
   unsigned int choice;
